  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 sol-sutun shadow">
        <a href="index.php" class="btn btn-outline-dark shadow mb-2 btn-left">Haberler</a>
        <a href="haberekle.php" class="btn btn-dark d-block shadow btn-left">Haber Ekle</a>
      </div>
      <div class="col-lg-9">
        <div class="row ps-5">
